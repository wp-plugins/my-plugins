...
Description: Displays all the plugins - just insert [my plugins] in post where you want to display a table of plugins that you use. <a href="http://matej.nastran.net/2008/02/18/plugini-ki-jih-uporabljam/">Example here</a>.
Version: 0.2
...
*/
$my_plugins_version = "0.2";

if (!function_exists("matej_register2"))
   include (ABSPATH . "wp-content/plugins/my-plugins/matej_register_en.php");
...
matej_register2 ("my_plugins", $my_plugins_version);
...
function matej_plugins ($content) {
         ...
         $plugins = get_plugins ();				
			...
			<br />Output generated by <em><a href="http://wordpress.org/extend/plugins/my-plugins/">My-Plugins</a></em> plugin by <a href=\"http://matej.nastran.net\">Matej Nastran</a>.<br /><br /> 
<?php 			
        $ret = ob_get_contents();
        ob_end_clean ();
